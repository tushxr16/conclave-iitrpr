          ...
          <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse justify-content-end" id="navbarText">
                  <ul class="navbar-nav mx-3 nav-tabs" role="tablist" id="mainNav">
                      ...
                      <li class="nav-item my-3">
                          <a aria-current="page"  href="#" class="gradient-box-outline  gradient-box">Schedule</a>
                      </li>
                      <li class="nav-item my-3">
    ...
    <div class="container max-width-lg cd-timeline__container">
      ...
      <div class="cd-timeline__block">
        <div class="cd-timeline__img cd-timeline__img--movie">
          <img src="images/schedule/inauguration.png" alt="Movie">
        </div> <!-- cd-timeline__img -->
      ...
      <div class="cd-timeline__block">
        <div class="cd-timeline__img cd-timeline__img--movie">
          <img src="images/schedule/school.png" alt="Movie">
        </div> <!-- cd-timeline__img -->
...
<!-- Next Day -->
  ...
  <section class="cd-timeline js-cd-timeline">
    <div class="container max-width-lg cd-timeline__container">
      ...
      <div class="cd-timeline__block">
        <div class="cd-timeline__img cd-timeline__img--picture">
          <img src="images/schedule/coffee-cup.png" alt="Picture">
        </div> <!-- cd-timeline__img -->
      ...
      <div class="cd-timeline__block">
        <div class="cd-timeline__img cd-timeline__img--location">
          <img src="images/schedule/food.png" alt="Location">
        </div> <!-- cd-timeline__img -->
